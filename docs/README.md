...
Det ena systemet levererar ett radbaserat filformat medan det andra kräver XML. Detta är en konverterare som bygger upp rätt XML-struktur. 
...
*sätt önskad fil i /input och döp till input.txt, xml-resultatet hamnar som en .xml fil i /output, kör programmet med `node index.js`*
